 ...
 * lv2_lv1_call
 */
static inline int lv2_lv1_call(uint64_t arg1, uint64_t arg2, uint64_t arg3, uint64_t arg4, uint64_t arg5, uint64_t arg6, uint64_t arg7, uint64_t system_call_lv1)
{
	lv2syscall8(10, arg1, arg2, arg3, arg4, arg5, arg6, arg7, system_call_lv1);
	return_to_user_prog(uint64_t);
}
 ...
 * lv2_sm_shutdown
 */
static inline int lv2_sm_shutdown(uint16_t op, const void *buf, uint64_t size, int unk)
{
	lv2syscall4(379, op, (uint64_t) buf, size, unk);
	return_to_user_prog(int);
}
